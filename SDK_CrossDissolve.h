...
#define	MAIN_CAMERA_FOV_MIN_VALUE			0.01
#define	MAIN_CAMERA_FOV_MAX_VALUE			10.0
#define	MAIN_CAMERA_FOV_MIN_SLIDER			0.15
#define	MAIN_CAMERA_FOV_MAX_SLIDER			5.0
#define	MAIN_CAMERA_FOV_DFLT				1.0

#define	MAIN_CAMERA_TINYPLANET_MIN_VALUE			0.0
#define	MAIN_CAMERA_TINYPLANET_MAX_VALUE			1.0
#define	MAIN_CAMERA_TINYPLANET_MIN_SLIDER			0.0
#define	MAIN_CAMERA_TINYPLANET_MAX_SLIDER			1.0
#define	MAIN_CAMERA_TINYPLANET_DFLT					0.0

#define	MAIN_CAMERA_RECTILINEAR_MIN_VALUE			0.0
#define	MAIN_CAMERA_RECTILINEAR_MAX_VALUE			1.0
#define	MAIN_CAMERA_RECTILINEAR_MIN_SLIDER			0.0
#define	MAIN_CAMERA_RECTILINEAR_MAX_SLIDER			1.0
#define	MAIN_CAMERA_RECTILINEAR_DFLT				0.0
...
typedef struct  CameraParams {
	...
	float fov = MAIN_CAMERA_FOV_DFLT;
	float tinyplanet = MAIN_CAMERA_TINYPLANET_DFLT;
	float rectilinear = MAIN_CAMERA_RECTILINEAR_DFLT;
}CameraParams;
